        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              <div class="text-h6">Data GAME</div>
              <div>Data Katalog GAME Anda</div>
            </q-banner>
          </div>
        </div>
      </div>
    ...
    <q-card>
      ...
      >
        <template v-slot:body="props">
          <q-tr :props="props">
            <q-td key="judulGame" :props="props">
                {{ props.row.judulGame }}
              </q-td>
            ...
            <q-td key="aksi" :props="props">
              <div class="row q-gutter-md">
                <q-btn :to="{ name:'formEditGAME', params: { id: props.row._id } }" label="Edit" icon="edit" color="warning" unelevated/>
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'judulGame', align: 'left', label: 'Judul Game', field: 'judulGame', sortable: true },
